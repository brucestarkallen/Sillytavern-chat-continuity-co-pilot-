...
(() => {
    ...
    const SHOWRUNNER_PASS_PROMPT = [
        ...
        '7. RECOGNITION \u2014 point to where someone\'s reading of the player is tested in front of witnesses and repriced on screen. If the reprice is a summary line, stage it; if no reading moves or hardens anywhere, the draft has skipped the payoff \u2014 build the audience, let the old reading score first, and give the room\'s reaction the screen time of a real scene. If the audience repeats the previous episode\'s, re-aim at a reading not yet moved \u2014 standing cast before new inventions, warm readings as lawful as cold.',
    ...
    function loadSettings() {
        ...
        const legacyPrompts = [LEGACY_DIRECTOR_PROMPT, LEGACY_DIRECTOR_PROMPT_V240.replace(HOOK_LINE, HOOK_LINE_2370), LEGACY_DIRECTOR_PROMPT_V240, LEGACY_DIRECTOR_PROMPT_V241, LEGACY_DIRECTOR_PROMPT_V246, LEGACY_DIRECTOR_PROMPT_V248, LEGACY_DIRECTOR_PROMPT_V251, LEGACY_DIRECTOR_PROMPT_V252, LEGACY_DIRECTOR_PROMPT_V257, LEGACY_DIRECTOR_PROMPT_V262, LEGACY_DIRECTOR_PROMPT_V263, LEGACY_DIRECTOR_PROMPT_V264, LEGACY_DIRECTOR_PROMPT_V265];
